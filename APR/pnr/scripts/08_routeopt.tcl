...
##############################################################
### load setting
source ./pnr/scripts/00_common_initial_settings.tcl
...
### initialize setting
source ./pnr/scripts/initialization_settings.tcl
...
source ./pnr/scripts/scenarios_setup.tcl
...
### starrc in design revised by chengquan
#cq set_app_options -name extract.starrc_mode -value in_design
#cq set_starrc_in_design -config ./pnr/scripts/starrc_in_design.config.txt
